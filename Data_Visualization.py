...
plt.ylabel('Absolute frequency of weather conditions (over all 97 train/val tfrecords')
plt.title('Frequency of weather conditions (over all 97 train/val tfrecords')
